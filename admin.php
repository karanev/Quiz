...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="index.php">Test Series </a></li>
...
<div class="jumbotron">
 ...
 <center>
    ...
    <p><form method="post" name="login" action="adminlogin.php">
    <?php
	...
	<div class="form-group">
  	<label class="control-label" for="inputDefault">Admin Username</label>
  	<input type="text" required class="form-control" name="username" id="inputDefault">
	</div>
	<div class="form-group">
  	<label class="control-label" for="1inputDefault">Admin Password</label>
